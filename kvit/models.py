...
class StopPapper(models.Model):
    ...
    lic5_pole = models.IntegerField(max_length=50, verbose_name='Лицевой №5', blank=True, null=True)
    lic6_pole = models.IntegerField(max_length=50, verbose_name='Лицевой №6', blank=True, null=True)
    lic11_pole = models.BooleanField(verbose_name='Лицевой №1-Отказ от бумажной квитанции', blank=True, null=True)
    lic12_pole = models.BooleanField(verbose_name='Лицевой №2-Отказ от бумажной квитанции', blank=True, null=True)
    lic13_pole = models.BooleanField(verbose_name='Лицевой №3-Отказ от бумажной квитанции', blank=True, null=True)
    lic14_pole = models.BooleanField(verbose_name='Лицевой №4-Отказ от бумажной квитанции', blank=True, null=True)
    lic15_pole = models.BooleanField(verbose_name='Лицевой №5-Отказ от бумажной квитанции', blank=True, null=True)
    lic16_pole = models.BooleanField(verbose_name='Лицевой №6-Отказ от бумажной квитанции', blank=True, null=True)